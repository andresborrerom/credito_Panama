...
<div class="container">
  ...
  <div class="card">
    <h2>1 · Actualizar datos</h2>
    <p style="font-size: 14px; color:#555;">
    Descarga los últimos datos (FRED, EODHD, último SEP de la Fed) y regenera
    todas las láminas, mensajes propuestos y el deck. Tarda ~2 minutos. También
    corre automáticamente el día 1° de cada mes a las 7 AM Colombia.</p>
    <button class="btn success" onclick="refreshData()">⚡ Actualizar datos ahora</button>
  </div>

  <div class="card">
    <h2>2 · Cortes disponibles para revisar y armar PPT</h2>
